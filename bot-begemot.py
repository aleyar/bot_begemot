...
──╚╝──╚═══╝     ╚═══╝╚═══╝     ╚═══╝╚═══╝╚╝─╚═╝──╚╝──╚══╝╚╝─╚═╝╚═══╝╚═══╝╚═══╝
    ...
    def play_round(self):
        ...
        self.sleep_message(
            "Доступные коэффициенты: [2, 4, 10]. Доступные диапазоны: [100, 1000, 10000]."
        )
        self.sleep_message(
            "Чтобы сделать ставку, введи сумму, коэффициент и диапазон через пробел (например: 500 4 1000).\n"
        )
